                        ...
                        <div className="flex flex-1 flex-col gap-2">
                          <div className="flex flex-wrap items-center gap-1">
                                    ...
                                    {(Object.keys(STATUS_META) as RoadmapStatus[]).map((status) => {
                                      ...
                                      return (
                                        <button
                                          ...
                                          className={`w-full px-3 py-2 text-left text-xs font-medium transition hover:bg-slate-100 dark:hover:bg-slate-800 ${
                                            isSelected
                            ...
                            {showTagSection && (
                              ...
                              <div
                                ...
                                className={`inline-flex flex-wrap items-center gap-2 rounded-full px-3 py-1 text-xs font-medium transition ${
                                  canManageTags
                                  ...
                                  orderedTagLabels.map((tagLabel, tagIndex) => {
                                    ...
                                    return (
                                      <span
                                        ...
                                        className="inline-flex items-center gap-1 rounded-full border border-slate-200/70 px-3 py-1 text-xs font-medium tracking-wide text-slate-700 dark:border-slate-600/60 dark:text-slate-100"
                                      >
                                          ...
                                          >
                                            <div className="flex items-center gap-2 px-2 py-1.5">
                                              <button
                                                ...
                                                className={`flex flex-1 items-center gap-2 rounded-full px-2 py-0.5 text-sm font-medium ${
                              ...
                              <div className="relative" data-roadmap-edit-control="true">
                                {activeEffortEdit?.itemId === item.id ? (
                                  ...
                                  <button
                                    ...
                                    className={`inline-flex items-center gap-2 rounded-full border border-slate-200/70 px-3 py-1 text-xs font-medium uppercase tracking-wide transition dark:border-slate-600/60 ${
                                      canEditEffort
                          ...
                          {titleEditing ? (
                            ...
                            <h2
                              ...
                              className={`text-lg font-medium text-slate-900 dark:text-white sm:text-xl ${
